import { observeWaterSurfaces, rainBurst, createThreeWater, setAmbientRain } from "./water-surface.js?v=20260710-117";
import { mountSkyBackground, setSkyWeather, getSkySunState, setSkyStepProgress, setSkySeasonOverride, setSkyHourOverride, triggerShootingStar, setSkyFlockListener, pokeSkyMoon } from "./sky-background.js?v=20260710-117";
import { initWeatherSync, WEATHER_PRESETS } from "./weather.js?v=20260710-117";
import { createPlantEffects, setPlantWind, setPlantRain, calmPlantEffects, shedPetalsNow } from "./plant-effects.js?v=20260710-117";
import { setSoundEnabled, isSoundEnabled, setRainSoundLevel, setWindSoundLevel, playRipplePlop, setFlockCalls, setAmbienceQuiet } from "./ambient-sound.js?v=20260710-117";
import {
  STAGE_THRESHOLDS,
  ...
  isPlantComplete,
  trimStepHistory
} from "./core/progress.js?v=20260710-117";
import {
  loadProgressState,
  saveProgressState,
  clearProgressState
} from "./storage/progress-store.js?v=20260710-117";
import { createModalController } from "./ui/modal-controller.js?v=20260710-117";
import { bindSettingsView, renderSettingsView } from "./views/settings-view.js?v=20260710-117";
import { bindCollectionView, renderCodexView, renderCollectionView } from "./views/collection-view.js?v=20260710-117";
import {
  bindHomeStatusView,
  renderCompletionPlaqueView,
  renderHomeProgressView
} from "./views/home-status-view.js?v=20260710-117";
...
const ASSET_VERSION = "20260710-117";
