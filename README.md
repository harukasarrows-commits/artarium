...
起動後、ブラウザで以下を開きます（`v=` は `index.html` の `?v=` に合わせる。2026-07-22 時点は `20260710-59`）。

- 本番: `http://127.0.0.1:3025/?v=20260710-59`
- デモ: `http://127.0.0.1:3025/?demo=1&v=20260710-59`
